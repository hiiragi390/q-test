    ...
    <div className="App" onLoad={AddKey}>
      <div className="canvasBody" id="test3">
        ...
        <div className="canvasWrap">
          ...
          <p className="bad_h">書けない</p>
          <p className="good_w">書ける</p>
          <div></div>
          ...
          <TwoDimMove classNum={0} Q_id={"Test1_dim"}></TwoDimMove>
        </div>
      </div>

      
      <div className="canvasBody" id="test2">
        <h3 id="test2_title">「きのこの山」と「たけのこの里」の<br></br>どちらが好きですか？</h3>
        
        <div className="test"></div>
        <div className="canvasWrap">

          <p className="mid">どちらとも言えない</p>
          <p className="kinoko">きのこの山</p>
          <p className="takenoko">たけのこの里</p>
          <p className="other">よく知らない</p>
          <div></div>
          ...
          {/*<HandleMove classNum={0} Q_id={"test1"}></HandleMove>*/}
          <HandleMove classNum={1} Q_id={"Test2_hand"}></HandleMove>
        </div>
      </div>
